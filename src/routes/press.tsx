...
export const Route = createFileRoute("/press")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "FinFlowTrack Press | News, Media Resources & Company Information",
      },
      {
        name: "description",
        content:
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-20 text-center">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            News, announcements, company information, and media resources
            about FinFlowTrack — a modern accounting and business management
            platform helping businesses manage their finances with confidence.
          </p>
      ...
      <section className="border-t py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-5 text-muted-foreground leading-8">
            ...
            platform designed to help freelancers, startups, small businesses,
            and growing organizations manage their financial operations.
          </p>

          <p className="mt-4 text-muted-foreground leading-8">
            The platform brings essential business tools together, including
            invoicing, expense tracking, inventory management, financial
        ...
        <div className="mx-auto grid max-w-5xl gap-8 px-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border p-8">
            ...
            <p className="mt-4 text-muted-foreground">
              Make financial management simpler, more accessible, and easier
          ...
          <div className="rounded-xl border p-8">
            ...
            <p className="mt-4 text-muted-foreground">
              Help businesses make better decisions through accessible
              financial technology and intelligent business tools.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-4 text-muted-foreground">
            Resources for journalists, partners, and organizations interested
            in learning more about FinFlowTrack.
          </p>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <article className="mt-8 rounded-xl border bg-background p-8">
            ...
            <p className="mt-4 text-muted-foreground leading-7">
              FinFlowTrack introduces a modern accounting platform designed to
              help businesses manage invoices, expenses, inventory, and
              financial operations from one place.
            </p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-5 text-muted-foreground leading-8">
            FinFlowTrack was created to address the challenges many businesses
            face when managing financial information, operational records, and
            business growth.
          </p>

          <p className="mt-4 text-muted-foreground leading-8">
            Our goal is to build accessible financial technology that helps
            entrepreneurs and organizations understand their numbers and make
            informed decisions.
          </p>
      ...
      <section className="py-20 text-center">
        ...
        <h2 className="text-3xl font-bold">
          Interested in learning more about FinFlowTrack?
        </h2>
