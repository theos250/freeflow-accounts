...
// Adjust this to however your app resolves the active company
// (route param, auth context, subdomain, etc).
function useActiveCompanyId(): string {
  // e.g. return useAuth().activeCompanyId;
  throw new Error('Wire useActiveCompanyId() up to your existing company/tenant context.');
}
