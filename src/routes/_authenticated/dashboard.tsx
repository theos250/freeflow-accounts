...
function Dashboard() {
  ...
  const kpis = [
    { label: "Revenue", value: stats.revenue, icon: DollarSign, delta: "+12.4%", up: true, tone: "text-emerald-600", bg: "bg-emerald-500/10" },
    { label: "Expenses", value: stats.expenses, icon: Receipt, delta: "-3.2%", up: false, tone: "text-amber-600", bg: "bg-amber-500/10" },
    { label: "Profit", value: stats.profit, icon: TrendingUp, delta: "+18.0%", up: true, tone: "text-primary", bg: "bg-primary/10" },
