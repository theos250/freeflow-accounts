        ...
        <div className="flex gap-2">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button onClick={openNew} className="bg-gradient-hero gap-1.5"><Plus className="h-4 w-4" /> New expense</Button>
            </DialogTrigger>
            <DialogContent>
      ...
      <div className="bg-card border rounded-xl">
        {items.length === 0 ? (
          <div className="p-12 text-center text-muted-foreground">
            No expenses yet. Click <span className="font-medium text-foreground">Scan receipt with AI</span> to add one in seconds.
          </div>
        ) : (
          <Table>
            <TableHeader>
