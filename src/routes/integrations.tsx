...
export const Route = createFileRoute("/integrations")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "FinFlowTrack Integrations | Connect Your Business Tools",
      },
      {
        name: "description",
        content:
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-20 text-center">
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            Build a connected business workflow by bringing your financial
            operations, productivity tools, and business systems together.
          </p>
      ...
      <section className="border-t py-16">
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-5 leading-8 text-muted-foreground">
            ...
            Businesses use multiple tools every day. FinFlowTrack is designed
            to help businesses create connected workflows by reducing manual
            data entry, improving accuracy, and making financial information
            easier to manage.
      ...
      <section className="bg-muted/30 py-16">
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 rounded-xl border bg-background p-8">
            ...
            <h3 className="font-semibold">
              FinFlowTrack Platform
            </h3>

            <p className="mt-3 text-muted-foreground">
              Built-in modules including accounting, invoicing, expenses,
              inventory, reporting, and company management.
            </p>
      ...
      <section className="bg-muted/30 py-16">
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-5 leading-8 text-muted-foreground">
            ...
            Future FinFlowTrack integrations will allow businesses and
            developers to connect external applications, automate workflows,
            and build customized financial solutions.
          ...
          <div className="mt-6 rounded-xl border bg-background p-6">
            ...
            <p className="mt-3 text-muted-foreground">
              Developer tools and API documentation will become available as
              the platform ecosystem grows.
            </p>
      ...
      <section className="py-16">
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-5 text-muted-foreground leading-8">
            ...
            Whether you are a freelancer, startup, small business, or growing
            organization, FinFlowTrack is designed to support flexible
            financial workflows that grow with your needs.
      ...
      <section className="py-20 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          Tell us what tools your business uses and help shape future
          FinFlowTrack integrations.
        </p>
